...
@Component({
  selector: 'app-warranty-monitoring-users',
  standalone: false,
  templateUrl: './warranty-monitoring-users.component.html',
  styleUrl: './warranty-monitoring-users.component.scss',
  animations: [
...
export class WarrantyMonitoringUsersComponent implements OnInit, OnDestroy {
